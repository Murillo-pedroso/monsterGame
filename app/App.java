...
public class App {
    public static void main(String[] args){
        ...
        listaMonstro.add(0, "Boitata", fogo, nulo, 1, 1, 1, 1, rajadaDeFogo,rosnado,mordida,erupcaoDeFogo);
        listaMonstro.add(1, "Cuca", dragao,psiquico,1,1,1,1,asasCortantes,raioPsiquico,tapaDeLama,pulsoDoDragao);
        ...
        listaMonstro.add(4,"Chibamba",planta,nulo,1,1,1,1,voadora,ataqueMalandro,tiroVenenoso,sementesVenenosas);
        listaMonstro.add(5,"Corpo Seco",fantasma,nulo,1,1,1,1,garraFantasmagorica,mordida,rosnado,bolaSombria);
        listaMonstro.add(6, "Curupira", lutador, nulo, 1, 1, 1, 1, rajadaDeFogo, voadora, ataqueMalandro, antonioNunes);
        listaMonstro.add(7,"Encantados",planta,fada,1,1,1,1,tiroVenenoso,cantoMagico,raioPsiquico,hiperFeixe);
        listaMonstro.add(8,"Gorjala",pedra,nulo,1,1,1,1,arremecoDePedra,rosnado,ataqueMalandro,desmoronamento);
        listaMonstro.add(9,"Homem do Saco", normal,nulo,1,1,1,1,ataqueMalandro,mordida,voadora,barrigada);
        listaMonstro.add(10,"Iara",agua,fada,1,1,1,1,esguichoDeAgua,cantoMagico,mordida,alagamento);
        listaMonstro.add(11,"Labatut",terra,nulo,1,1,1,1,tapaDeLama,arremecoDePedra,ataqueMalandro,terremoto);
        listaMonstro.add(12,"Lobisomem",sombrio,nulo,1,1,1,1,rosnado,mordida,garraFantasmagorica,escuridao);
        listaMonstro.add(13, "Loura do Banheiro",fantasma,nulo, 1,1,1,1,raioPsiquico,garraFantasmagorica,ataqueMalandro,bolaSombria);
        listaMonstro.add(14,"Mula sem Cabeça",fogo,nulo,1,1,1,1,rajadaDeFogo,voadora,ataqueMalandro,erupcaoDeFogo);
        listaMonstro.add(15,"Negrinho do Pastoreio",fada,nulo,1,1,1,1,cantoMagico,raioPsiquico,ataqueMalandro,bonsSonhos);
