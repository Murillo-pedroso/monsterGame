...
public class App {
        ...
        public static void main(String[] args) {
                ...
                AtaqueCarregado sementesVenenosas = new AtaqueCarregado("Sementes Venenosas", planta, 10, 4,
                                Efeito.ENVENENADO);
                AtaqueCarregado pulsoDoDragao = new AtaqueCarregado("Pulso do Dragao", dragao, 12, 4, Efeito.NULO);
                AtaqueCarregado confusaoMental = new AtaqueCarregado("Confusao Mental", psiquico, 5, 4,
                                Efeito.ATORDOADO);
                ...
                listaMonstro.add(0, "Boitata", fogo, nulo, 50, 30, 10, 10, rajadaDeFogo, rosnado, mordida,
                                erupcaoDeFogo);
                ...
                listaMonstro.add(3, "Cabra Cabriola", sombrio, nulo, 1, 1, 1, 1, mordida, ataqueMalandro, rosnado,
                                escuridao);
                ...
                listaMonstro.add(5, "Corpo Seco", fantasma, nulo, 1, 1, 1, 1, garraFantasmagorica, mordida, rosnado,
                                bolaSombria);
                listaMonstro.add(6, "Curupira", lutador, nulo, 1, 1, 1, 1, rajadaDeFogo, voadora, ataqueMalandro,
                                antonioNunes);
                ...
                listaMonstro.add(8, "Gorjala", pedra, nulo, 1, 1, 1, 1, arremecoDePedra, rosnado, ataqueMalandro,
                                desmoronamento);
                listaMonstro.add(9, "Homem do Saco", normal, nulo, 25, 25, 10, 40, ataqueMalandro, mordida, voadora,
                                barrigada);
                ...
                listaMonstro.add(11, "Labatut", terra, nulo, 1, 1, 1, 1, tapaDeLama, arremecoDePedra, ataqueMalandro,
                                terremoto);
                listaMonstro.add(12, "Lobisomem", sombrio, nulo, 1, 1, 1, 1, rosnado, mordida, garraFantasmagorica,
                                escuridao);
                ...
                listaMonstro.add(16, "Saci", lutador, nulo, 1, 1, 1, 1, ataqueMalandro, voadora, raioPsiquico,
                                antonioNunes);
                listaMonstro.add(17, "Alma de Gato", fogo, sombrio, 1, 1, 1, 1, rajadaDeFogo, rosnado, mordida,
                                escuridao);
                ...
                do {
                        ...
                        switch (escolha) {
                                case 1:
                                        if (vezTreinadorUm) {
                                                do{
                                                        combate.imprimeCombateMenu(treinadorUm, treinadorDois);
                                                        treinadorUm.ataques();
                                                        ...
                                                        if(treinadorUm.getMonstro().getAtaqueCarregado(treinadorUm.getMonstroAtualId()).getEnergia()<1){
                                                ...
                                                if(escolhaAtaque!=4){
                                                        modificadorDano = listaMonstro.getAtaque(treinadorUm.getMonstroAtualId(), (escolhaAtaque-1)).getDano();
                                                }else{
                                                        modificadorDano = listaMonstro.getAtaqueCarregado(treinadorUm.getMonstroAtualId()).getDano();

                                                        treinadorUm.getMonstro().getAtaqueCarregado(treinadorUm.getMonstroAtualId()).setEnergia
                                                        (treinadorUm.getMonstro().getAtaqueCarregado(treinadorUm.getMonstroAtualId()).getEnergia()-1);
                                                }
                                                combate.calculaAtaque(treinadorUm, treinadorDois, modificadorDano);
                                        }else{
                                                combate.imprimeCombateMenu(treinadorDois, treinadorUm);
